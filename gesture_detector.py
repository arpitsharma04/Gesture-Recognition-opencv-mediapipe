...
def detect_heart_gesture(all_hands):
    ...
    return calculate_distance(thumb1, thumb2) < 0.15 and calculate_distance(index1, index2) < 0.15
...
def is_two_fingers_straight(landmarks):
    """Detects if index and middle fingers are straight while others are folded."""
